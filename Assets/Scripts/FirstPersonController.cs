...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        playerInput.actions["Moverse"].performed += Moviendose;
        playerInput.actions["Moverse"].canceled += CancelarMovimiento;


        //playerInput.deviceLostEvent.AddListener((x) => Debug.Log("Reconecta el mando, por favor")); Con haces cosas para hacer cosas
        //playerInput.SwitchCurrentActionMap("Coche"); Con esto puedes cambiar los controles dependiendo del mapa o el objeto.
    }


    private void Moviendose(InputAction.CallbackContext ctx)
    {
